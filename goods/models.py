...
class Address(models.Model):
    user = models.ForeignKey(User, models.CASCADE)              # 关联用户id
...
class Orders(models.Model):
    address = models.ForeignKey(Address, models.CASCADE)        # 关联送货地址id
...
class Order(models.Model):
    order = models.ForeignKey(Orders, models.CASCADE)           # 关联总订单id
    user = models.ForeignKey(User, models.CASCADE)              # 关联用户id
    goods = models.ForeignKey(Goods, models.CASCADE)            # 关联商品id
